...
```
**5.1.4.** Создать исполняемый файл с расширением `.sh` который автоматизирует выгрузку данных из контейнера в основную ОС данных, которые получены в результате работы `DAG` в `Apache Airflow`. 
